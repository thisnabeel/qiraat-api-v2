...
async function fetchPage(pageNumber) {
  const url = `https://qul.tarteel.ai/resources/mushaf-layout/313?page=${pageNumber}`;
      ...
      try {
        ...
        if (attempt < 2) {
          ...
          try {
            ...
            console.error('Page loaded with domcontentloaded');
            navigationSuccess = true;
          } catch (e2) {
...
const pageNumber = process.argv[2] || '4';
fetchPage(parseInt(pageNumber)).catch((error) => {
